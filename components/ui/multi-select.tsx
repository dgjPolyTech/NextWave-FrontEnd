...
function MultiSelect({
  ...
  return <SelectPrimitive.Root data-slot="multi-select" {...props} />
}
...
function MultiSelectValue({
  ...
  return <SelectPrimitive.Value data-slot="multi-select-value" {...props} />
}

interface MultiSelectTriggerProps extends React.ComponentProps<typeof SelectPrimitive.Trigger> {
  size?: 'sm' | 'default'
}
...
function MultiSelectListbox({
  ...
  return <SelectPrimitive.Viewport data-slot="multi-select-listbox" {...props} />
}
